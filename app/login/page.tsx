...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res?.error === 'too_many_attempts') {
      setError('เข้าสู่ระบบผิดพลาดหลายครั้งเกินไป กรุณารอ 15 นาทีแล้วลองใหม่')
      return
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required autoComplete="username" placeholder="กรอก username"
            ...
            <div>
              ...
              <input
                ...
                required autoComplete="current-password" placeholder="กรอก password"
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal focus:border-transparent transition-all placeholder:text-gray-400"
              />
            </div>
